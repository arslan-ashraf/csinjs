...
from .views import user_login, create, update, delete, profile, change_password, user_logout, user_notifications
...
urlpatterns = [
	...
	url(r'^user/notifications/$', user_notifications, name = 'user_notifications'),
